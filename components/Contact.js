...
export default function Contact() {
  return (
    <section>
      <div className="max-w-6xl mx-auto h-20 md:h-32 bg-white dark:bg-gray-800 antialiased">
        <h1 className=" text-5xl md:text-9xl font-bold py-2 text-center md:text-left">
          Contact
        </h1>
      </div>
      <div className="relative z-10 rounded-md shadow-md bg-[#02044A]
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
          <div className="md:ml-4">
            <header className="">
              ...
              <p className="font-light text-base text-gray-200 mt-1">
            ...
            <div className="icons-container inline-flex flex-col my-10">
              ...
              border border-[#02044A] hover:border hover:border-blue-500 p-2">
                <svg
              ...
              <div className="flex flex-row items-center space-x-6 rounded-md border
               border-[#02044A] hover:border hover:border-blue-500 p-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
